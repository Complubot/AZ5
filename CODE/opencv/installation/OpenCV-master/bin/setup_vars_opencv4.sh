...
[[ ! "${OPENCV_QUIET}" ]] && ( echo "Setting vars for OpenCV 4.0.1-dev" )
export LD_LIBRARY_PATH="$SCRIPT_DIR/../lib:$LD_LIBRARY_PATH"

if [[ ! "$OPENCV_SKIP_PYTHON" ]]; then
  PYTHONPATH_OPENCV="$SCRIPT_DIR//home/complubot/Documents/POLLOTRON/CODE/opencv/OpenCV-master-py3/lib/python3.6/site-packages"
