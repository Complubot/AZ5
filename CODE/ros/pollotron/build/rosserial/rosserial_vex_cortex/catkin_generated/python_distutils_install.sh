...
echo_and_run cd "/home/complubot/Documents/POLLOTRON/CODE/ros/pollotron/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/complubot/Documents/POLLOTRON/CODE/ros/pollotron/build/rosserial/rosserial_vex_cortex" \
    install \
    $DESTDIR_ARG \
