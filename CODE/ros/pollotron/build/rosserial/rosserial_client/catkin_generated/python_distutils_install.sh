...
echo_and_run cd "/home/complubot/Documents/POLLOTRON/CODE/ros/pollotron/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/complubot/Documents/POLLOTRON/CODE/ros/pollotron/build/rosserial/rosserial_client" \
    install \
    $DESTDIR_ARG \
