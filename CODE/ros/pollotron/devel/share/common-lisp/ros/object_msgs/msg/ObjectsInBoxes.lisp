...
(cl:defclass <ObjectsInBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (inference_time_ms
    :reader inference_time_ms
    :initarg :inference_time_ms
    :type cl:float
    :initform 0.0))
)
...
(cl:defmethod cl:initialize-instance :after ((m <ObjectsInBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ObjectsInBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name object_msgs-msg:<ObjectsInBoxes> is deprecated: use object_msgs-msg:ObjectsInBoxes instead.")))
...
(cl:defmethod objects_vector-val ((m <ObjectsInBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:objects_vector-val is deprecated.  Use object_msgs-msg:objects_vector instead.")
  (objects_vector m))

(cl:ensure-generic-function 'inference_time_ms-val :lambda-list '(m))
(cl:defmethod inference_time_ms-val ((m <ObjectsInBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader object_msgs-msg:inference_time_ms-val is deprecated.  Use object_msgs-msg:inference_time_ms instead.")
  (inference_time_ms m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ObjectsInBoxes>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-single-float-bits (cl:slot-value msg 'inference_time_ms))))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ObjectsInBoxes>) istream)
  ...
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
    ...
    (cl:setf (cl:slot-value msg 'inference_time_ms) (roslisp-utils:decode-single-float-bits bits)))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ObjectsInBoxes>)))
  ...
  "2c070e019267e39d554a36de7d183780")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ObjectsInBoxes)))
  "Returns md5sum for a message object of type 'ObjectsInBoxes"
  "2c070e019267e39d554a36de7d183780")
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ObjectsInBoxes>))
  ...
  (cl:list 'ObjectsInBoxes
    ...
    (cl:cons ':inference_time_ms (inference_time_ms msg))
))
