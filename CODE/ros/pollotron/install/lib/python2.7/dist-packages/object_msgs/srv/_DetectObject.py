...
class DetectObjectResponse(genpy.Message):
  ...
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """ObjectsInBoxes[] objects
      ...
      for val1 in self.objects:
        ...
        for val2 in val1.objects_vector:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
          buff.write(_get_struct_f().pack(_v3.probability))
          _v4 = val2.roi
          _x = _v4
          buff.write(_get_struct_4IB().pack(_x.x_offset, _x.y_offset, _x.height, _x.width, _x.do_rectify))
        buff.write(_get_struct_f().pack(val1.inference_time_ms))
    except struct.error as se: self._check_types(struct.error("%s: '%s' when writing '%s'" % (type(se), str(se), str(locals().get('_x', self)))))
    except TypeError as te: self._check_types(ValueError("%s: '%s' when writing '%s'" % (type(te), str(te), str(locals().get('_x', self)))))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v7.object_name = str[start:end].decode('utf-8')
          else:
      ...
      for val1 in self.objects:
        ...
        for val2 in val1.objects_vector:
          ...
          if python3 or type(_x) == unicode:
            ...
            length = len(_x)
          buff.write(struct.pack('<I%ss'%length, length, _x))
          buff.write(_get_struct_f().pack(_v11.probability))
          _v12 = val2.roi
          _x = _v12
          buff.write(_get_struct_4IB().pack(_x.x_offset, _x.y_offset, _x.height, _x.width, _x.do_rectify))
        buff.write(_get_struct_f().pack(val1.inference_time_ms))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v15.object_name = str[start:end].decode('utf-8')
          else:
