...
(cl:defmethod cl:initialize-instance :after ((m <ultrasounds>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ultrasounds)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name controller-msg:<ultrasounds> is deprecated: use controller-msg:ultrasounds instead.")))

(cl:ensure-generic-function 'measurements-val :lambda-list '(m))
(cl:defmethod measurements-val ((m <ultrasounds>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader controller-msg:measurements-val is deprecated.  Use controller-msg:measurements instead.")
  (measurements m))
