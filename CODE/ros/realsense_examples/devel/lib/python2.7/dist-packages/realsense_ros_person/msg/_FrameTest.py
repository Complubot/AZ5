...
"""autogenerated by genpy from realsense_ros_person/FrameTest.msg. Do not edit."""
import sys
...
class FrameTest(genpy.Message):
  _md5sum = "758e664f737fbe3bbd452e73af9b8744"
  _type = "realsense_ros_person/FrameTest"
...
"""
  __slots__ = ['colorImage','frameData']
  _slot_types = ['sensor_msgs/Image','realsense_ros_person/Frame']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3I().pack(_x.colorImage.header.seq, _x.colorImage.header.stamp.secs, _x.colorImage.header.stamp.nsecs))
      ...
      _x = self
      buff.write(_get_struct_2I().pack(_x.colorImage.height, _x.colorImage.width))
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_BI().pack(_x.colorImage.is_bigendian, _x.colorImage.step))
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.frameData.numberOfUsers))
      length = len(self.frameData.usersData)
      buff.write(_struct_I.pack(length))
      for val1 in self.frameData.usersData:
        _v1 = val1.userInfo
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.colorImage.header.seq, _x.colorImage.header.stamp.secs, _x.colorImage.header.stamp.nsecs,) = _get_struct_3I().unpack(str[start:end])
      start = end
      end += 4
      ...
      if python3:
        self.colorImage.header.frame_id = str[start:end].decode('utf-8')
      else:
        self.colorImage.header.frame_id = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.colorImage.height, _x.colorImage.width,) = _get_struct_2I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      if python3:
        self.colorImage.encoding = str[start:end].decode('utf-8')
      else:
        self.colorImage.encoding = str[start:end]
      _x = self
      start = end
      end += 5
      (_x.colorImage.is_bigendian, _x.colorImage.step,) = _get_struct_BI().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (self.frameData.numberOfUsers,) = _get_struct_i().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      self.frameData.usersData = []
      for i in range(0, length):
        ...
        self.frameData.usersData.append(val1)
      return self
