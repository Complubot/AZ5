...
"""autogenerated by genpy from realsense_ros_slam/ResetRequest.msg. Do not edit."""
import sys
...
class ResetRequest(genpy.Message):
  ...
  _type = "realsense_ros_slam/ResetRequest"
...
def _get_struct_I():
    ...
    return _struct_I
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from realsense_ros_slam/ResetResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ResetResponse(genpy.Message):
  ...
  _type = "realsense_ros_slam/ResetResponse"
  _has_header = False #flag to mark the presence of a Header object
...
def _get_struct_B():
    ...
    return _struct_B
class Reset(object):
  _type          = 'realsense_ros_slam/Reset'
  _md5sum = '3a1255d4d998bd4d6585c64639b5ee9a'
