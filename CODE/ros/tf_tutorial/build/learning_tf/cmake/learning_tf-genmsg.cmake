...
message(STATUS "learning_tf: 1 messages, 0 services")

set(MSG_I_FLAGS "-Ilearning_tf:/home/complubot/Documents/POLLOTRON/CODE/ros/tf_tutorial/src/learning_tf/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/complubot/Documents/POLLOTRON/CODE/ros/tf_tutorial/src/learning_tf/msg/ultrasounds.msg" NAME_WE)
add_custom_target(_learning_tf_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "learning_tf" "/home/complubot/Documents/POLLOTRON/CODE/ros/tf_tutorial/src/learning_tf/msg/ultrasounds.msg" ""
)
...
_generate_msg_cpp(learning_tf
  "/home/complubot/Documents/POLLOTRON/CODE/ros/tf_tutorial/src/learning_tf/msg/ultrasounds.msg"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf)
  install(CODE "execute_process(COMMAND \"/usr/bin/python\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/learning_tf\")")
  # install generated code
  install(
